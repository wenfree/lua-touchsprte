				...
				elseif UI_pic('返回','研究院界面')then
					if not(d('返回_科技选择界面_第二队例'))then
						...
						if not(d('返回_科技选择界面_科技展开'))then
							...
							elseif 研究方向 == 2 then
								click(科技位置[tonumber(values.hero_setting)][1],科技位置[tonumber(values.hero_setting)][2])
							end
						end
						delay(1)
...
t['城堡中_矮人']={ 0x4bf9ff, "16|30|0xd23139,-16|10|0xde404e", 90, 1076, 471, 1239, 602 } --
t['城堡中_巫妖']={ 0xffe386, "9|6|0x5b5147,7|-3|0xffd577", 90, 997, 465, 1093, 569 } --
