...
t['弹窗_双蓝按钮_右左']={ 0x28abbe, "-341|-4|0x27a5bd,124|-48|0x49acca,22|35|0xd6fff9,-485|-18|0x8bd7ec", 90, 313, 392, 1008, 534 } --多点找色
...
--				log(UIdata)
		...
		if UIdata then
			...
			local mainlist ={
				...
				['7主线']=7,['8返击']=8,['9采矿']=9,['10战争学院']=10,['11清理']=11,['12开龙']=12,['13造兵']=13,['14散兵']=14,['15广告']=15}
