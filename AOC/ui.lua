...
aoc['返回']={}
	aoc['返回']['返回图标']={{37,29,0xf1f093}, }
		...
		t['返回_龙巢界面']={ 0x35393f, "1|27|0xc4c4c4,55|29|0x727477,148|1|0x282d34,148|30|0xc6c7c7", 90, 133, 11, 303, 56 } --多点找色
			...
			t['返回_龙巢界面_喂养']={ 0x2194b6, "-102|-30|0x3094b9,49|26|0x2998bc", 90, 583, 581, 1084, 713 ,{orient = 5}} --多点找色
			t['返回_龙巢界面_进阶']={ 0x41cb39, "-125|-30|0x46aa5f,20|11|0x47d237", 90, 792, 576, 1059, 723 ,{orient = 5}} --多点找色
