...
t['升级-升级按钮'] = { 0xc2ff,"101|2|0xc2ff,-158|2|0xfeaf00,-298|-3|0xfeb200",degree,638,381,1162,682}
    t['升级-升级按钮-雇佣']={0x009ec8, "0|0|0x009ec8,2|4|0xfffccb,4|6|0xa96f50,59|-20|0xffb000",90,915,433,1145,580}
        t['升级-升级按钮-雇佣-建造']={0x00c2ff, "0|0|0x00c2ff,76|-186|0x00c6ff,64|1|0x1274ba",90,907,153,1150,480}
		...
		if d("升级-升级按钮",false,1,2)then
			...
			if (dengji=='2' or dengji=='3') and not( d("升级-宝石不足") ) then
				...
				if d("升级-升级按钮",true,1,2)then
				    if d("升级-升级按钮-雇佣",true,1,2) then d("升级-升级按钮-雇佣-建造",true,1,2) end
...
t['劫掠者-聊天']={0xffffff, "0|0|0xffffff,-78|-23|0x0c5582",90,14,616,181,742}
t['劫掠者-聊天窗口']={0xb49461, "0|0|0xb49461,0|-9|0xfff2e6,-897|-5|0xb49461,-907|-3|0xfff2e6",90,3,2,971,73}
    t['劫掠者-聊天窗口-未激活']={0x2b2317, "0|0|0x2b2317,-6|-23|0x483b26,281|-26|0x4a3d28",90,5,49,354,185}
    t['劫掠者-聊天窗口-位置']={ 0x0099d7, "0|0|0x0099d7,-1|-13|0xf7f0e5,-1|31|0x007eb2,-10|-70|0x58bade",90,385,425,877,689}
    
t['劫掠者-劫掠者-位置']={0x000000, "0|0|0x000000,0|10|0x138f16,1|1|0x000000",90,154,90,1231,661}

function 劫掠者()
    d("劫掠者-聊天窗口-未激活",true,1,2)
    while d("劫掠者-聊天窗口") do
        moveTo(648,575,638,203,20)
        delay(2)
        d("劫掠者-聊天窗口-位置",true,1,2)
        
        if d("劫掠者-劫掠者-位置",true,1,3)then
