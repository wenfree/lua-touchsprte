...
t['造兵-车兵工厂11']={0xfdc079, "0|0|0xfdc079,27|-8|0x005db3,23|30|0x004076,-4|8|0xfcc074,-38|14|0xffaf6c",90,19,19,1317,721}
...
function read_mail()
    ...
    if d('邮件-邮件',true,1,4)then
        ...
        local 派遣次数 = 0
        while d('邮件-邮箱界面')  and _UI.读邮件 and os.time() - mailtime < 20 do
