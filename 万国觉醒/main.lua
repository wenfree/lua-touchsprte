...
t['弹窗—验证图片']= { 0x1274ba, "0|0|0x1274ba,28|-5|0x00c7ff,-58|-3|0x00c5ff,9|-283|0x000000",90,200,92,1328,452}
...
t['弹窗-常见问题']={0x007aff, "0|0|0x007aff,548|4|0x000000,298|0|0xf8f8f8",90,20,7,747,53}
    t['弹窗-ipad-bug']={0xffffff, "0|0|0xffffff,-53|-101|0xe5b565,-53|14|0xf1bc6a,-49|-16|0x81eeff",90,672,726,672,726}
...
function _升级子程序()
    ...
    while (d("升级-升级按钮") or d("升级-前往")) and i < 20 do
		...
		elseif (i%2== 0 and d("升级-前往2",true,1,2)) or d("升级-前往",true,1,2) then
