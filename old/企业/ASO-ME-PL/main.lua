...
m = {}
--------------------------------全局参数-----------------------------------------------
m['灰']={{397,5,0x939394},{415,5,0x939394},{430,5,0x939394},}
--------------------------------登录判断区域-------------------------------------------------
...
m['open']={}
m['open']['详情页']={ 0x007aff, 90, 455, 45, 515, 113}
---------------------------------下载区域----------------------------------------------------
	...
	while (true) do
		...
		elseif login_setp == 5 then
			...
			elseif c_pic(m.登录,'登录')then
				delay(3)
				input("\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b")
				input(account)
				click(597,1095) --点击换行
				input(password)
				click(597,1095) --点击登录
